...
import FormCadastroMorador from "./components/FormCadastroMorador/FormCadastroMorador";
...
export default function EntryPage() {
  ...
  return (
    <main className="min-h-screen bg-transparent py-10 flex justify-center">
      <Tabs defaultValue="account">
        <TabsList>
          <TabsTrigger value="account">Registrar entrada / saida</TabsTrigger>
          <TabsTrigger value="password">Cadastro de morador</TabsTrigger>
          <TabsTrigger value="list">Lista de moradores</TabsTrigger>
        </TabsList>
        <TabsContent value="account">
          <div className="max-w-2xl min-w-2xl mx-auto bg-background-panel shadow-xl rounded-2xl p-6 md:p-10 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col md:flex-row md:items-end gap-2 w-full relative">
                ...
                <div className="w-full md:w-auto">
                  <ModalNovaPessoa
                    onPessoaCadastrada={(nova) => setPessoa(nova)}
                  />
                </div>
              </div>
            </div>
